...
abstract class AndroidTestContext implements RunConfigurationContext {
  ...
  /**
   * Sets up {@link BlazeCommandRunConfiguration} with fqcn and method name as returned by {@link
   * #getFullyQualifiedClassName} and {@link #getMethodName}
   */
  @Override
  public boolean setupRunConfiguration(BlazeCommandRunConfiguration config) {
    ...
    configState.setClassName(getFullyQualifiedClassName());
  ...
  /** Returns true if the the context has an associated method */
  protected abstract boolean hasTestMethod();
  ...
  /** Returns AndroidTestContext specific from Java PSI */
  @Nullable
  ...
  private static class JavaAndroidTestContext extends AndroidTestContext {
    ...
    @Override
    protected boolean hasTestMethod() {
